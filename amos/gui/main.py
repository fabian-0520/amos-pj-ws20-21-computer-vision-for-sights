...
class UiMainWindow(QWidget):
    ...
    def __init__(self, parent) -> None:
        ...
        self.Box_Camera_selector.activated.connect(
        ...
        label_height = (
                               self.window_height - self.dist - self.button_height - self.dist
    ...
    def detect_sights(self) -> None:
        ...
        if self.stacked_widget.currentIndex() == 0:
            ...
            if city == "Choose City":
                ...
                prediction_path = get_current_prediction_output_path(
                    OUTPUT_PREDICTION_DIR, image_name
                )
