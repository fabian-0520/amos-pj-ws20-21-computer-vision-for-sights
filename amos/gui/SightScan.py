...
class UI_MainWindow(QWidget):
    ...
    def start_detection (self):
        ...
        image_index = self.Label_Bild.image_name.rfind('/')
        image = self.Label_Bild.image_name[image_index:]
        yoloPath = './../sight_detector/yolov5'
        guiPath = './../../gui'
        os.chdir(yoloPath)

        # delete images from data
        if( os.path.isdir('./data/images') == True ):
            for file in os.listdir('./data/images'):
                os.remove('./data/images/' + file)
        # create images directory
        elif( os.path.isdir('./data/images') == False ):
            os.mkdir('./data/images')

        # copy image to data
        shutil.copy2(self.Label_Bild.image_name, './data/images')
