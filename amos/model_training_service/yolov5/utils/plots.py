...
def plot_one_point(x, img, color=None, label=None, point_thickness=None, r=0):
    ...
    if label:
        ...
        cv2.putText(img, label, (middle[0] + r + 2, middle[1] - r - 2), 0, 1,
                    color=[255, 255, 255], thickness=tf * 2, lineType=cv2.LINE_AA, bottomLeftOrigin=False)
        cv2.putText(img, label, (middle[0]+r, middle[1]-r), 0, 1, color=[0, 0, 0],
                    thickness=tf*2, lineType=cv2.LINE_AA, bottomLeftOrigin=False)
